...
![FAIRCAST Logo](frontend/public/faircast.svg)
...
| `SMS_API_KEY` | Email service API key | `your-api-key` |
| `SMS_API_SECRET` | Emai service API secret | `your-api-secret` |
| `SMS_FROM` | Email sender email address | `glowieglosh@gmail.com` |
